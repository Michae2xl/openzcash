...
import { IconGrid, IconNews, IconReceipt } from "@/components/icons";
import {
  getNews,
  nowMs,
  type NewsItem,
...
> = {
  forum: { label: "Forum", Icon: IconNews },
  github: { label: "GitHub", Icon: IconGrid },
  sheet: { label: "Spreadsheet", Icon: IconReceipt },
};
