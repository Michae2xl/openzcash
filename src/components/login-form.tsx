  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-900 outline-none ring-amber-500/30 placeholder:text-stone-600 focus:ring-2"
      />
      <button
        type="submit"
        disabled={busy}
